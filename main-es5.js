...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_users_users_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/users/users.component */
    "./src/app/components/users/users.component.ts");
    /* harmony import */


    var _components_repositories_repositories_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(loadingBar, router) {
        ...
        this.router = router;
        this.title = 'GithubSearch'; // @ts-ignore
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 2,
      consts: [[3, "color", "height"], [1, "navbar", "navbar-expand-sm", "bg-light"], [1, "container-fluid"], [1, "navbar-nav"], [1, "nav-item"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-link"], [1, "container"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_repositories_repositories_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/repositories/repositories.component */
    "./src/app/components/repositories/repositories.component.ts");
    /* harmony import */
    ...
    var ng2_slim_loading_bar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ng2-slim-loading-bar */
    "./node_modules/ng2-slim-loading-bar/__ivy_ngcc__/index.js");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], ng2_slim_loading_bar__WEBPACK_IMPORTED_MODULE_8__["SlimLoadingBarModule"].forRoot(), _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_9__["ToastrModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_repositories_repositories_component__WEBPACK_IMPORTED_MODULE_4__["RepositoriesComponent"], _components_users_users_component__WEBPACK_IMPORTED_MODULE_5__["UsersComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], ng2_slim_loading_bar__WEBPACK_IMPORTED_MODULE_8__["SlimLoadingBarModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_9__["ToastrModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsRepositoriesRepositoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_repositories_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    function RepositoriesComponent_tr_28_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var userRepository_r6 = ctx.$implicit;
    ...
    function RepositoriesComponent_tr_32_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      if (rf & 2) {
        var userFollower_r7 = ctx.$implicit;
    ...
    /*#__PURE__*/
    function () {
      function RepositoriesComponent(repositoriesService) {
      ...
      _createClass(RepositoriesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.repositoriesService.getUserRepositories(this.githubUserInfo.repos_url).subscribe(function (data) {
            _this2.userRepositories = data;
            _this2.repositoryCount = _this2.userRepositories.length || 0;
          });
          this.repositoriesService.getUserFollowers(this.githubUserInfo.followers_url).subscribe(function (data) {
            _this2.userFollowers = data;
            _this2.followerCount = _this2.userFollowers.length || 0;
          });
        }
      }]);
    ...
    RepositoriesComponent.ɵfac = function RepositoriesComponent_Factory(t) {
      return new (t || RepositoriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_repositories_service__WEBPACK_IMPORTED_MODULE_1__["RepositoriesService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RepositoriesComponent, [{
        ...
        return [{
          type: _services_repositories_service__WEBPACK_IMPORTED_MODULE_1__["RepositoriesService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppComponentsUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function UsersComponent_div_14_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function UsersComponent(formBuilder, notification, router, slimLoadingBarService, userService) {
      ...
      _createClass(UsersComponent, [{
        ...
        value: function getGithubUser(username) {
          ...
          this.userService.getGithubUser(username).subscribe(function (data) {
            _this3.items = data['items']; // process results from query

            _this3.startLoading();

            if (_this3.items.length === 1) {
              // save items to local storage
              localStorage.setItem('githubUserInfo', JSON.stringify(_this3.items[0])); // redirect to repositories

              _this3.router.navigateByUrl('/repositories');
            } else {
              // toast error
              _this3.notification.showError('Please provide YOUR specific username.', 'Invalid username');
            }
      ...
      template: function UsersComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_Template_button_click_16_listener() {
            ...
            return ctx.getGithubUser(_r0.value);
          });
  ...
  /***/
  function srcAppHelpersAuthHeadersTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "authHeader", function () {
      return authHeader;
    });
    /* harmony import */
    ...
    var authHeader = 'token ' + _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].oauth_token;
    /***/
  },
  ...
  /***/
  function srcAppServicesRepositoriesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RepositoriesService", function () {
    ...
    var _helpers_auth_headers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function () {
      function RepositoriesService(http) {
        _classCallCheck(this, RepositoriesService);
      ...
      _createClass(RepositoriesService, [{
        key: "getGithubUserInfo",
        value: function getGithubUserInfo() {
          return localStorage.getItem('githubUserInfo');
        }
      }, {
        key: "getUserRepositories",
        value: function getUserRepositories(repos_url) {
          return this.http.get(repos_url, this.httpOptions);
        }
      }, {
        key: "getUserFollowers",
        value: function getUserFollowers(followers_url) {
    ...
    RepositoriesService.ɵfac = function RepositoriesService_Factory(t) {
      return new (t || RepositoriesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    RepositoriesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: RepositoriesService,
      factory: RepositoriesService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RepositoriesService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function srcAppServicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_auth_headers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../helpers/auth.headers */
    "./src/app/helpers/auth.headers.ts");
    /* harmony import */
    ...
    function () {
      function UserService(http) {
        ...
        this.http = http; //define endpoint to query

        this.searchUsersEndpoint = _app_config__WEBPACK_IMPORTED_MODULE_2__["configs"].apiBaseURL + '/search/users'; // define http-options
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/reuben/Documents/GithubSearch/GithubSearch/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
